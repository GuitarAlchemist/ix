...
- [ix-full-vision · `ix`](../../docs/brainstorms/2026-03-14-ix-full-vision-brainstorm.md)
- [ix-ml-builder · `ix`](../../docs/brainstorms/2026-03-15-ix-ml-builder-brainstorm.md)
- [transformer-training · `ix`](../../docs/brainstorms/2026-03-15-transformer-training-brainstorm.md)
- [dimensionality-reduction-coverage · `ix`](../../docs/brainstorms/2026-04-09-dimensionality-reduction-coverage.md)
- [ix-code-observatory · `ix`](../../docs/brainstorms/2026-04-09-ix-code-observatory-brainstorm.md)
...
- [Karnaugh maps for tetravalent logic minimization · `ix`](../../docs/solutions/feature-implementations/karnaugh-tetravalent-logic.md)
...
- [Power-of-two-only test inputs hide padding/truncation bugs in signal & transform code · `ix`](../../docs/solutions/math-correctness/2026-06-07-power-of-two-test-masking.md)
- [Measuring guitar inharmonicity — fixed-f0 fit is corrupted by pitch error; the engine is not "too harmonic" · `ix`](../../docs/solutions/math-correctness/2026-06-08-inharmonicity-estimator-pitch-error-confound.md)
- [Jacobi vs power iteration for matrices with repeated eigenvalues · `ix`](../../docs/solutions/math-correctness/jacobi-vs-power-iteration-repeated-eigenvalues.md)
...
- [feat: ML pipeline builder — ephemeral and persistent pipelines via skill + MCP tool · `ix`](../../docs/plans/2026-03-15-001-feat-ml-pipeline-builder-plan.md)
- [feat: Code Observatory - 5-Layer Analysis System · `ix`](../../docs/plans/2026-04-09-001-feat-code-observatory-5-layer-analysis-plan.md)
- [feat: R4 Meta-MCP Gateway (demerzel-gateway) · `ix`](../../docs/plans/2026-04-14-001-feat-r4-meta-mcp-gateway-plan.md)
- [2026-04-18-optic-k-v4-pp-per-partition-norm · `ix`](../../docs/plans/2026-04-18-optic-k-v4-pp-per-partition-norm.md)
- [2026-04-19-mcp-sampling-fallback · `ix`](../../docs/plans/2026-04-19-mcp-sampling-fallback.md)
- [2026-04-19-optick-invariant-checker · `ix`](../../docs/plans/2026-04-19-optick-invariant-checker.md)
- [2026-04-19-voice-leading-pairs-schema · `ix`](../../docs/plans/2026-04-19-voice-leading-pairs-schema.md)
- [ix-autoresearch — Karpathy-style edit-eval-iterate kernel + 3 targets · `ix`](../../docs/plans/2026-04-26-001-feat-ix-autoresearch-edit-eval-iterate-plan.md)
- [2026-05-02-stable-tier-promotion · `ix`](../../docs/plans/2026-05-02-stable-tier-promotion.md)
- [2026-05-02-voicings-in-prime-radiant · `ix`](../../docs/plans/2026-05-02-voicings-in-prime-radiant.md)
...
- [IXQL verified effect runtime tracer bullet · `ix`](../../docs/plans/2026-08-14-ixql-verified-effect-runtime-plan.md)

### runtime-errors (2)

- VoicingTagEnricher never tagged Cmaj7 as jazz — substring match on wrong field · `ga` — `docs/solutions/runtime-errors/enricher-substring-on-wrong-field-cmaj7-jazz.md`
- F# Module Initializers, GaAsync Covariance, and DSL Closure Wiring · `ga` — `docs/solutions/runtime-errors/fsharp-module-init-closure-registry.md`

### test-failures (1)

- [Kernel PCA test assertion fails on symmetric input — centroids collapse to zero · `ix`](../../docs/solutions/test-failures/kernel-pca-symmetric-centroid-trap.md)

### tooling (3)

- /octo:review silent failure: env unquoted PATH on Windows + doctor formatter bash bugs · `ga` — `docs/solutions/tooling/2026-05-10-octo-plugin-install-corruption-silent-gate-failure.md`
...
- Connect curated music theory YAML files to the RAG pipeline via a generic knowledge loader · `ga` — `docs/solutions/integration-issues/2026-03-07-yaml-knowledge-loader-rag-pipeline-integration.md`
