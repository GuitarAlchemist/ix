...
## 4. The 57 MCP tools — by category
...
| **Source adapters (P1)** | `ix_git_log`, `ix_cargo_deps`, `ix_code_analyze` | [`ix-agent/src/handlers.rs`](../crates/ix-agent/src/handlers.rs) |
